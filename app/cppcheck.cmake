...
# it creates a `__compiler.h` file with options implicitly passed by the selected toolchain
...
add_custom_target(cppcheck_generate_compiler_header ALL
  COMMAND ${CMAKE_C_COMPILER} ${TOOLCHAIN_C_FLAGS} -E -dM ${output_dir}/empty.c > ${output_dir}/__compiler.h
  DEPENDS ${output_dir}/empty.c
  COMMENT "Generating __compiler.h"
  BYPRODUCTS ${output_dir}/__compiler.h
  VERBATIM
)

set(CPPCHECK_VERBATIM_ARGS
  "--include=${output_dir}/__compiler.h"
